 ...
 */
export function persistQueryClientSubscribe(props: PersistedQueryClientSaveOptions) {
 ...
 */
export function persistQueryClient(props: PersistQueryClientOptions): [() => void, Promise<void>] {
